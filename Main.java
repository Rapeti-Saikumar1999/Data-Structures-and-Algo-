...
public class Main {
  ...
  // primitive: byte(8 bits),short, int(4 bytes), char(2 bytes), boolean(1 byte),
  ...
  switch(value) // use switch instead of using more no of if-else statements
{
  ...
  // loops are used to execute the block of statements repetitively untill a
  // certain condition met. it contains initialization , condition check,
  // increment
  // for-loop
  for(
  int i = 0;i<10;i++)
...
if(prime){
  ...
  *************************
  ...
  1 212 32123 4321234 543212345 for(
  int i = 1;i<=n;i++)
  {
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    int a = sc.nextInt();
    int b = sc.nextInt();
    System.out.println(calProduct(a,b));
